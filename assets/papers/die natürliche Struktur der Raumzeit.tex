...
\textbf{Claim level:} Exploratory theory draft. Equations and interpretations are proposed working hypotheses pending derivation checks, consistency checks, and empirical testing.\\
\textbf{Use:} Use for derivation development, notation review, and test design.
