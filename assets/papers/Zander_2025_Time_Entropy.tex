...
\title{Zeit und Entropie als emergente Phänomene der diskreten Raumzeit}
...
\textbf{Claim level:} Exploratory theory draft. Claims about emergence of time/entropy should be treated as hypotheses pending formal derivation and consistency checks.\\
\textbf{Use:} Use for conceptual development and formalization planning.
