...
\textbf{Claim level:} Exploratory theory draft. Interpretive conclusions and broad claims should be treated as provisional until supported by explicit derivations and comparison to established results.\\
\textbf{Use:} Use for conceptual development and derivation planning.
...
Damit erfüllt das System die Unitarität exakt – unter einer minimal-natürlichen Annahme:  
der endlichen Auflösung der Raumzeit selbst.
...
versuchten, das Paradoxon durch zusätzliche Modellannahmen zu entschärfen,
